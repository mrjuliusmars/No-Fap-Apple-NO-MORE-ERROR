...
struct CalculatingView: View {
    ...
    var body: some View {
        ...
        ZStack {
                ...
                VStack(spacing: 0) {
                    // Top section with back button only
                    HStack {
                        // Back button
                        Button(action: {
    ...
    private func startCalculating() {
        ...
        let stepDuration: Double = 0.08 // Update every 0.08 seconds for smoother animation
        ...
        func updateProgress(step: Int) {
            if step < totalSteps {
                ...
                // Add haptic feedback at key milestones
                if step % 10 == 0 {
                ...
                let finalGenerator = UIImpactFeedbackGenerator(style: .medium)
