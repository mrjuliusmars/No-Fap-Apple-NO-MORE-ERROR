...
struct AnimatedEnergyDrainView: View {
    ...
    private func startAnimations() {
        ...
        // Hour hand - slow acceleration
        withAnimation(.easeIn(duration: 8.0)) {
            hourHandRotation = 720 // 2 full rotations
        }
        
        // Minute hand - medium acceleration  
        withAnimation(.easeIn(duration: 6.0)) {
            minuteHandRotation = 1440 // 4 full rotations
        }
        
        // Second hand - fast constant spinning
            ...
            .fill(
                RadialGradient(
                    gradient: Gradient(colors: [
                        ...
                        Color.purple.opacity(clockGlow * 0.4),
                        Color.clear
                    ]),
                    center: .center,
                    startRadius: 0,
