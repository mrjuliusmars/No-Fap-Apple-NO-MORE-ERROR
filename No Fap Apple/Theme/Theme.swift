...
enum Theme {
    ...
    // MARK: - Premium Purple Color Palette
    static let primaryPurple = Color(red: 0.25, green: 0.1, blue: 0.45)        // Deep purple primary
    static let primaryPurpleDark = Color(red: 0.15, green: 0.05, blue: 0.3)    // Darker purple
    static let primaryBlue = Color(red: 0.2, green: 0.4, blue: 1.0)            // Keep blue for accents
    
    // Premium background colors
    static let surfacePrimary = Color(red: 0.08, green: 0.02, blue: 0.2)       // Very dark purple
    static let surfaceSecondary = Color(red: 0.15, green: 0.05, blue: 0.3)     // Dark purple cards
    static let surfaceTertiary = Color(red: 0.25, green: 0.1, blue: 0.45)      // Medium purple
    ...
    static let primaryGradient = LinearGradient(
        colors: [
            Color(red: 0.25, green: 0.1, blue: 0.45),   // Deep purple top
            Color(red: 0.15, green: 0.05, blue: 0.3),   // Darker purple middle
            Color(red: 0.08, green: 0.02, blue: 0.2),   // Very dark purple bottom
